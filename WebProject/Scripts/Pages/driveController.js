        ...
        initGrid: function (drives) {
            ...
            $("#driveGrid").jsGrid({
                ...
                fields: [
                    ...
                    { name: "InitialGPSKM", title: 'KM Gps Initiali', type: "text", width: 50 },
                    { name: "FinalGPSKM", title: 'KM Gps Finali', type: "text", width: 50 },
                    { name: "DistanceGPS", title: 'KM Gps', type: "text", width: 50 },
                    { name: "DistanceGgl", title: 'KM Ggl', type: "text", width: 50 },
